...
This package provides https://pkl-lang.org/package-docs/pkg.pkl-lang.org/pkl-pantry/pkl.github.dependabotManagedActions/current/DependabotManagedActions/index.html[DependabotManagedActions], a helper for writing Github Actions workflows whose actions are pinned to git SHA, and updated by Dependabot.
...
2. Process the https://pkl-lang.org/package-docs/pkg.pkl-lang.org/pkl-pantry/com.github.actions/current/AbstractJob/index.html#steps[steps] within each passed in workflow:
...
For ready-to-go examples, see the link:./examples/[examples] directory.
